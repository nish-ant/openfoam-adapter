# OpenFOAM-preCICE adapter v1.2.0 with custom variables for FF coupling
...
Motivated to use preCICE with SOWFA-6 library, this version builds on top of the preCICE OpenFOAM adapter v1.2.0 to include following variables for FF coupling:
- PressureRgh
- Temperature
- EddyViscosity
